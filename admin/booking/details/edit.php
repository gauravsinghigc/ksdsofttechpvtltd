                  ...
                  <form action="../../../controller/bookingcontroller.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="crn_no" placeholder="KSD-YV/###/" class="form-control" value="<?php echo FETCH($BookingSql, "crn_no"); ?>">
                      </div>

                      <div class="col-md-4 form-group">
                        <label>Update CRN No</label>
                        <input type="text" name="ref_no" placeholder="CRN:YV/###" class="form-control" value="<?php echo FETCH($BookingSql, "ref_no"); ?>">
                      </div>
