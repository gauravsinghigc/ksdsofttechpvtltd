                ...
                <div class="panel-body">
                  ...
                  <div class="col-md-6">
                    ...
                    <table class="table table-striped p-1" style="font-size:11px !important;">
                      ...
                      <tr>
                        <td align="right"></td>
                        <td colspan="6"><span class="text-grey">Balance (<?php echo 100 - round($PaymentforProjects / $net_payable_amount * 100, 2); ?>%) &nbsp;</span><span class="text-danger fs-15">Rs.<?php echo $net_payable_amount - ($PreviousPayment + $PaymentforProjects); ?></span></td>
                      </tr>
                      <tr>
                        <td align="right"></td>
