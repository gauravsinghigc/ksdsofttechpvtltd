...
<head>
  ...
  <title>Send Demand Letter : <?php echo company_name; ?></title>
            ...
            <div class="col-md-12 col-lg-12 col-12">
              <div class="panel square">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="m-t-0"><i class="fa fa-exchange text-danger"></i> Send Payment Request (Demand Letter) : <span class="text-grey"> <?php echo $MainBookingID; ?></span></h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <p class="data-list text-right">
                        <span>Net Paid (<?php $Pending = $full - round((int)$net_paid_amount2 / (int)$Payable * 100, 2);
                      ...
                      ?>
                        <p class="data-list text-right">
                          <span>Previously Paid (<?php echo round((int)$PreviousPayment / (int)$Payable * 100, 2); ?>%):</span>
                          <b><?php echo Price($PreviousPayment, "", "Rs."); ?></b>
                        </p>
                      <?php }
                      $CheckSqlForReSale = CHECK("SELECT * FROM booking_resales where booking_main_id='$bookingid' and booking_resale_type='TRANSFER'");
                      if ($CheckSqlForReSale != null) {
                      ...
                      ?>
                        <p class="data-list text-right">
                          <span>Net Total Paid (<?php echo $Percentage = round(($PreviousPayment + $PaymentforProjects) / (int)$Payable * 100, 2); ?>%) :</span>
                          <b><?php echo Price($PreviousPayment + $PaymentforProjects, "", "Rs."); ?></b>
                        </p>
                      <?php
                        $Percentage = 100 - $Percentage;
                      } else {
                        $Percentage = $full - (round((int)$net_paid_amount2 / (int)$Payable * 100, 2));
                      } ?>
                      <p class="data-list text-right">
                        <span>Balance (<?php echo $Percentage; ?>%):</span>
                        <b><?php echo Price($Balance = (int)$Payable - (int)$net_paid_amount2 - $PreviousPayment, "text-danger", "Rs."); ?></b>
                      </p>

                    </div>
                    <div class="col-md-4">
                      <h4 class="section-heading">Previous Demand Letters</h4>
                      <?php
                      $Demands = FetchConvertIntoArray("SELECT * FROM booking_pay_req where PayReqType='DEMAND' and PayReqBookingId='$bookingid'", true);
                      if ($Demands != null) {
                        foreach ($Demands as $d) { ?>
                          <p class="data-list m-b-0" style="display:flex !important;flex-direction: column;padding:0.4rem !important;">
                            <span class="w-100">
                              ...
                              (<?php $REQ = round($dmdamount / $Payable * 100, 2);
                                echo 100 - (100 - $REQ); ?>%) @
                            ...
                            <span class="w-100">
                              <a target="_blank" href="../docs/dmd-l.php?id=<?php echo $bookingid; ?>&dmdid=<?php echo $d->PaymentRequestId; ?>" class="btn btn-sm btn-primary" style="margin-left:0px !important;">View Demand Letter</a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <h4 class="section-heading">Send Payment Request or Demand Letter</h4>
                      <form action="../../../controller/bookingcontroller.php" method="POST">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <button type="submit" name="GenerateDemandLetter" class="btn btn-lg btn-success">Generate Demand
                              Letter</button>
                            <a target="_blank" href="../docs/dmd-l.php?id=<?php echo $bookingid; ?>&dmdid=<?php echo $DmdId; ?>" class="btn btn-lg btn-default">View Latest Demand Letter</a>
                          </div>
                        </div>
                      </form>
                    </div>
    ...
    <script>
      function ReceiveBookingAmount() {
        ...
        if (applicablereceivebookingamount.value == 0 || applicablereceivebookingamount.value == "0") {
          ...
          var realProjectAmount = parseFloat(RealProjectAmount);
          var applicableReceiveBookingAmount = parseFloat(applicablereceivebookingamount.value);
          var result = Math.round((realProjectAmount / 100) * applicableReceiveBookingAmount * 100) / 100;
          var new_booking_amount = result.toFixed(2);
