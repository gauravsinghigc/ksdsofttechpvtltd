                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php } ?>
                      <p class="data-list text-right">
                        <span>Balance (<?php echo $full - round((int)$net_paid_amount2 / (int)$Payable * 100, 2); ?>%):</span>
                        ...
                        foreach ($Demands as $d) { ?>
                          <p class="data-list" style="display:flex !important;flex-direction: column;padding:0.4rem !important;">
                            <span class="w-100">
                              ...
                              (<?php $REQ = round((int)$dmdamount / $Payable * 100, 2);
                                echo 100 - (100 - $REQ); ?>%) @
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <button type="submit" name="GenerateDemandLetter" class="btn btn-lg btn-success">Generate Reminder
                              Letter</button>
                            <a href="../docs/remd-l.php?id=<?php echo $bookingid; ?>&dmdid=<?php echo $DmdId; ?>" target="_blank" class="btn btn-lg btn-default">View Latest Reminder Letter</a>
                          </div>
                        </div>
                      </form>
                    </div>
