...
<body onload="doConvert()" style=" font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI' , Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans' , 'Helvetica Neue' , sans-serif !important;margin-left:1.5rem;">
  <section style="padding:0.5rem;margin:2% auto;display:block;">
    ...
    <div>
      <h2 style="text-align:center;margin-top: -1.5rem;margin-bottom:-0.2rem !important;">Reminder Letter <br>
        ...
        <p style="display:flex;justify-content:space-between;font-size:14px;">
          ...
          <span style="text-align:right;">
            <span><b>Reminder Date :</b> <?php echo DATE_FORMATE2("d M, Y", FETCH($DMDSql, "PayReqDate")); ?></span><BR>
    ...
    <div style="font-size:14px !important;">
      ...
      <p style="margin-top:0px !important;"><br><br>
        ...
        <br>
        This is with reference to your above booking/allotment, where in, “Current Reminder
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Current Due
                ...
                Previous Due</td>
              <td><?php echo Price($currentdue = (int)$current - (int)$net, "", "Rs."); ?></td>
            </tr>
            <tr>
      ...
      <p STYLE="margin-bottom:0px !important;">
        ...
        outstanding/due installment/ and <?php echo FETCH($DMDSql, "PayRequestDescriptions"); ?>, within 7 days of this Reminder Letter through
