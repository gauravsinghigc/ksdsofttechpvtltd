                ...
                <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="flex-s-b">
                        <div class="btn-group btn-group-sm w-100 m-b-10">
                          ...
                          <?php if (isset($_GET['bookingid'])) {
                            ...
                            $crn_no = $_GET['crn_no'];
                            $status = $_GET['status']; ?>
                            <a href="<?php echo DOMAIN; ?>/admin/booking/export_all.php?status=<?php echo $status ?>&bookingid=<?php echo $bookingid; ?>&project_name=<?php echo $project_name; ?>&unit_name=<?php echo $unit_name; ?>&unit_area=<?php echo $unit_area; ?>&unit_rate=<?php echo $unit_rate; ?>&customer_id=<?php echo $customer_id; ?>&partner_id=<?php echo $partner_id; ?>&booking_date=<?php echo $booking_date; ?>&created_at=<?php echo $created_at; ?>&possession=<?php echo $possession; ?>&crn_no=<?php echo $crn_no; ?>" target="blank" class="btn btn-default square">Export PDF</a>
                          <?php } else { ?>
                            <a href="<?php echo DOMAIN; ?>/admin/booking/export_all.php" target="blank" class="btn btn-default square">Export PDF</a>
                          <?php } ?>
                          <?php if (isset($_GET['bookingid'])) {
                            $bookingid = $_GET['bookingid'];
                            $project_name = $_GET['project_name'];
                            ...
                            $crn_no = $_GET['crn_no'];
                            $status = $_GET['status']; ?>
                            <a href="<?php echo DOMAIN; ?>/admin/booking/export_csv.php?status=<?php echo $status ?>&bookingid=<?php echo $bookingid; ?>&project_name=<?php echo $project_name; ?>&unit_name=<?php echo $unit_name; ?>&unit_area=<?php echo $unit_area; ?>&unit_rate=<?php echo $unit_rate; ?>&customer_id=<?php echo $customer_id; ?>&partner_id=<?php echo $partner_id; ?>&booking_date=<?php echo $booking_date; ?>&created_at=<?php echo $created_at; ?>&possession=<?php echo $possession; ?>&crn_no=<?php echo $crn_no; ?>" target="blank" class="btn btn-default square">Export CSV</a>
                          <?php } else { ?>
                            <a href="<?php echo DOMAIN; ?>/admin/booking/export_csv.php" target="blank" class="btn btn-default square">Export CSV</a>
                          <?php } ?>
                        </div>
                        <div class="btn-group-sm btn-group w-50 pull-right">
                    ...
                    <div class="col-md-12">
                      ...
                      <div id="filters" style="display:<?php echo $display; ?>;">
                        ...
                        <form class="mt-5" action="" method="get">
                          <div class="row mt-2">
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" name="bookingid" value="<?php echo IfRequested("GET", "bookingid", "", false); ?>" class="form-control form-control-sm" list="bookingid">
                              <?php SUGGEST("bookings", "bookingid", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Project Name</label>
                              <input type="text" name="project_name" value="<?php echo IfRequested("GET", "project_name", "", false); ?>" class="form-control form-control-sm" list="project_name">
                              <?php SUGGEST("bookings", "project_name", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Plot No</label>
                              <input type="text" name="unit_name" value="<?php echo IfRequested("GET", "unit_name", "", false); ?>" class="form-control form-control-sm" list="unit_name">
                              <?php SUGGEST("bookings", "unit_name", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Plot Area</label>
                              <input type="text" name="unit_area" list="unit_area" value="<?php echo IfRequested("GET", "unit_area", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "unit_area", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Plot Rate</label>
                              <input type="text" name="unit_rate" list="unit_rate" value="<?php echo IfRequested("GET", "unit_rate", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "unit_rate", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Customer ID</label>
                              <input type="text" name="customer_id" list="customer_id" value="<?php echo IfRequested("GET", "customer_id", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "customer_id", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Agent ID</label>
                              <input type="text" name="partner_id" list="partner_id" value="<?php echo IfRequested("GET", "partner_id", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "partner_id", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Booking From Date</label>
                              <input type="date" name="booking_date" list="booking_date" value="<?php echo IfRequested("GET", "booking_date", date("Y-m-d"), false); ?>" class="form-control form-control-sm">
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Booking To Date</label>
                              <input type="date" name="created_at" list="created_at" value="<?php echo IfRequested("GET", "created_at", date("Y-m-d"), false); ?>" class="form-control form-control-sm">
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By Possession</label>
                              <input type="text" name="possession" list="possession" value="<?php echo IfRequested("GET", "possession", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "possession", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>Filter By CRN NO</label>
                              <input type="text" name="crn_no" list="crn_no" value="<?php echo IfRequested("GET", "crn_no", "", false); ?>" class="form-control form-control-sm">
                              <?php SUGGEST("bookings", "crn_no", "ASC"); ?>
                            </div>
                            <div class="form-group col-md-2">
                              <label>By Status</label>
                              <select name='status' onchange='form.submit()' class='form-control'>
                                <?php echo InputOptions(
                                  ...
                                  IfRequested("GET", "status", "", false)
                                ); ?>
                              </select>
                            </div>
                            <div class="form-group col-md-2">
                              <button type="submit" name="ApplyFilters" class="btn btn-sm btn-success">Apply Filters</button>
                            </div>
                          </div>
                        </form>
                      </div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr loading="lazy">
                                ...
                                <td>
                                  <?php
                                  $BookingType = FETCH("SELECT * FROM booking_resales where booking_main_id='$bookingid'", "booking_resale_type");
