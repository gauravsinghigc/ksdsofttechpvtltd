                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          if (isset($_GET['search'])) {
                            ...
                            $getpayments = SELECT("SELECT *, payments.payment_id AS 'payment_delete_id', payments.created_at AS 'payment_created_at' FROM payments, bookings where DATE($search_type) like '%$search_value%' and payments.bookingid=bookings.bookingid order by payments.payment_id DESC");
                          } else {
                            $getpayments = SELECT("SELECT *, payments.payment_id AS 'payment_delete_id', payments.created_at AS 'payment_created_at' FROM payments, bookings where payments.bookingid=bookings.bookingid order by payments.payment_id DESC limit $start, $listcounts");
                          }
