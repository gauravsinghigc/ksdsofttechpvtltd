...
if (isset($_POST['create_payment'])) {
  ...
  if ($payment == "save") {
    ...
    while ($FetchAllPayments = mysqli_fetch_array($getpayments)) {
      ...
      $PaymentEmailData = '
      <p>New EMI is received succesfully on date ' . $payment_created_date_full . ' having amount Rs.' . $net_paid_amount . ', whose Transaction Reference ID is :' . $paymentreferenceid . '</p>
      <h2>Payment Details</h2>
      <table style="width:100% !important;">
      <tr class="striped text-left">
        <th class="text-left" align="left">Payment Ref ID:</th>
        <td>#' . $paymentreferenceid . '</td>
      </tr>
      <tr class="striped text-left">
        <th class="text-left" align="left">Paying EMI MONTH</th>
        <td>' . $payment_created_date . '</td>
      </tr>
      <tr class="striped text-left">
        <th class="text-left" align="left">Paid Amount</th>
        <td>Rs.' . $net_paid_amount . '</td>
      </tr>
      <tr class="striped text-left">
      ...
      <table style="text-align:left;line-height: 15px;width:100%;">
        <tr>
                        <th style="width:35%;">Customer ID : </th>
                        <td>CUST00' . $customer_id . '</td>
                    </tr>
                    <tr>
                        <th>Customer Name :</th>
                        <td>' . $customer_name . '</td>
                    ...
                    <tr>
                        <th>Address :</th>
                        <td>' . "$user_street_address $user_area_locality $user_city $user_state $user_pincode $user_country" . '</td>
                    </tr>
                    <tr>
                        <th>Phone Number :</th>
                ...
                <h2>Project Details</h2>
                 <table style="text-align:left;line-height: 15px;">
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>Total EMI Months:</th>
                        <td>' . $emi_months . '</td>
                    </tr>
                     <tr>
                        <th>Payable EMI Amount Per Month:</th>
                        <td>Rs.' . $emi_per_month . ' every month</td>
                    </tr>
                ...
                <table style="text-align:left;line-height: 15px;">
                    <tr>
                        <th>Date:</th>
                        <td>' . date("d M, Y h:m A", strtotime($created_at)) . '</td>
                    </tr>
                    <tr>
                        <th>Invoice No:</th>
                        <td>B' . $bookingid . "/" . date("m/Y", strtotime($created_at)) . '</td>
                    </tr>
                    <tr>
                        <th>Sale Date:</th>
...
<br>
                <h2>View Receipt</h2>
                <a href="' . DOMAIN . '/admin/booking/emi_receipt.php?id=' . $bookingid . '&payment_id=' . $payment_id . '" style="pading:0.5rem 1rem:background-color: #7b1fa2 !important;font-size:1.5rem;text-decoration:none;">View Receipt</a>';
      header_remove();
    }

    SENDMAILS("EMI Received : $paymentreferenceid", "<br>Dear, " . company_name . "<br>", company_email, $PaymentEmailData);
