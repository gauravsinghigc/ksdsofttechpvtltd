...
//ai save and update
function SIU($tablename, $ReqtablePrimaryId, array $Req, array $msg, $die = false)
{
...
function IfIsset($Request, array $req, $msg, $die = false)
{
    if (isset($Request['req'])) {
        SIU($Request['db_table'], $Request['p_id'], $req, $msg, $die);
    } else {
